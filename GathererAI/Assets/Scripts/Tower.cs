...
public class Tower {
    ...
    private void IncreaseConstructionTick() {
        if (IsConstructing()) {
            ...
            case 3:  spriteRenderer.sprite = GameAssets.i.towerConstruction_2;     
                    break;
            case 6:  spriteRenderer.sprite = GameAssets.i.towerConstruction_3;     
                    break;
            case 10: spriteRenderer.sprite = GameAssets.i.towerConstruction_4;  
                    break;
            }
